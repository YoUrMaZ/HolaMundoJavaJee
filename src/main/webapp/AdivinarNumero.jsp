...
<%@ page import = "es.carlosgs.introjee.beans.BeanAdivinarNumero" %>
...
<jsp:useBean id="adivinarNumero" class="es.carlosgs.introjee.beans.BeanAdivinarNumero" scope="session" />
